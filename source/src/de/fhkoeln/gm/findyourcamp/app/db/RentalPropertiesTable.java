...
public class RentalPropertiesTable extends Table {
	...
	private static final String CREATE_TABLE = "CREATE TABLE rental_properties (" + COLUMN_NAME_RENTAL_PROPERTY_ID
		+ " INTEGER PRIMARY KEY AUTOINCREMENT, " + COLUMN_NAME_RENTAL_PROPERTY_LOCATION + " TEXT NOT NULL, "
		...
		+ COLUMN_NAME_RENTAL_PROPERTY_REMOTE_ID + " INTEGER DEFAULT 0, " + COLUMN_NAME_FEATURE_TOILETS_AVAILABLE_KEY
		+ " INTEGER NOT NULL DEFAULT 0, " + COLUMN_NAME_FEATURE_BBQ_ALLOWED_KEY + " INTEGER NOT NULL DEFAULT 0, "
	...
	private static final String DROP_TABLE = "DROP TABLE IF EXISTS rental_properties";
