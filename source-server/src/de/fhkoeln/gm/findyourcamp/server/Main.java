...
/**
 * Ausfuehrung des Clients fuer GCM Cloud Connection Server. Baut Verbindung zur
 * Datenbank und GCM CSS auf und richtet bei Bedarf neue Tabellen ein.
 * 
 */
public class Main {
	...
	/**
	 * Methode richtet Verbindung zur Datenbank und GCM ein. Bei Fehler
	 * Rueckgabe der Problemstelle.
	 */
	public Main() {
		...
		// Prueft ob bereits Tabellen in der Datenbank angelegt wurden, sonst
		// neu anlegen
		checkAppStatus();
	...
	/**
	 * Prüft, ob eine beliebige Tabelle existiert. Ansonsten Aufbau neuer
	 * Tabellen.
	 */
	...
	/**
	 * Ausfuehrung der Serveranwendung. Status der Zwischenschritte werden über
	 * Konsolenausgabe notiert.
	 * 
	 * @param args
	 */
