...
public class RentalProperty {
	 ...
	 * @param userEmail
	 */
	public static long createRentalPropertyEntry( long rentalPropertyLocalId, String rentalPropertyLocation, long userId ) {
		...
		try {
			...
			statement.executeUpdate( "INSERT INTO " + RentalPropertiesTable.TABLE_NAME + " ("
				+ RentalPropertiesTable.COLUMN_NAME_LOCATION_ID + "," + RentalPropertiesTable.COLUMN_NAME_USER_ID + ","
				+ RentalPropertiesTable.COLUMN_NAME_RENTAL_PROPERTY_LOCAL_ID + ") " + "VALUES ( '" + locationId
				+ "', '" + userId + "', '" + rentalPropertyLocalId + "');", Statement.RETURN_GENERATED_KEYS );
